 (function($){
    ...
    var get_property = function(){
	  ...
	  $.ajax({
					...
					url: site_url+"manage_property/get_property_json/",
					data: formdata,
					contentType: false,
					processData: false,
					type:'POST',
					beforeSend: function(){
						//$('#left_lurny_detail_page').html("<div class='lurnyfied-view-img'><img width='50' height='50'  src='"+site_url+"assets_new/img/2.gif'></div>");
					},
